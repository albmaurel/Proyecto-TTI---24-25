...
Matrix& VarEqn(double x, Matrix yPhi) {
    ...
    Matrix r = extract_vector(transpose(yPhi),1, 3);
    Matrix v =  extract_vector(transpose(yPhi),4, 6);
    ...
    Matrix a = transpose(AccelHarmonic ( transpose(r), E, AuxParam.n, AuxParam.m ));
